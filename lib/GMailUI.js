...
GMailUI.UIElement = (function() {
  ...
  function UIElement(html, hoverClass) {
...
GMailUI.PopupLink = (function(_super) {

  __extends(PopupLink, _super);

  PopupLink.template = _.template("<div class=\"J-N aMS\" id=\"ms\" role=\"menuitem\">\n  <div class=\"J-N-Jz\"><%- label %></div>\n</div>");

  PopupLink.hoverClass = 'J-N-JT';

  function PopupLink(label) {
    this.setElement(GMailUI.PopupLink.template({
      label: label
    }));
  }
